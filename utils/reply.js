...
function error(error) {
    if (error instanceof Error) {
        return createResp(status_error, error.message, null, type_error error.stack);
    } else {
        return createResp(status_error, error, null, type_error);
    }
}

function fatal(error) {
    if (error instanceof Error) {
        return createResp(status_error, error.message, null, type_fatal,  error.stack);
    } else {
        return createResp(status_error, error, null, type_fatal);
    }
}
